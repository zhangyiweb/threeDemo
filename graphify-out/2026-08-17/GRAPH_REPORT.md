...
Cohesion: 0.16
Nodes (15): AdditiveBlending Glow, 12.激光特效, EffectComposer, Laser Trail Particles, BokehPass Depth of Field, 13.后期处理特效 · Post Processing, EffectComposer, OutlinePass (+7 more)
...
Cohesion: 0.03
Nodes (18): applyOptions(), createTypedArrayLoader(), createTypedArrayLoaderClass(), getRectangle(), getSize(), getTile(), includeRenderTargets(), onBeforeCompile() (+10 more)
...
Cohesion: 0.10
Nodes (31): applyMatrix4(), applyOptions2(), assertType(), at(), copy(), copyCameraSettings(), copyReprojection(), copyShadow() (+23 more)
...
Cohesion: 0.09
Nodes (25): distance(), equals(), getFrustumRadius(), getNormalAtHorizon(), getTextureDataType(), invariant(), isTypedArray(), outputBuffer() (+17 more)
...
Cohesion: 0.15
Nodes (14): createData3DTextureLoader(), createData3DTextureLoaderClass(), createDataLoaderClass(), createDataTextureLoader(), createDataTextureLoaderClass(), height(), isHostLittleEndian(), load() (+6 more)
